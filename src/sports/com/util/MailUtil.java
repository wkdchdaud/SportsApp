...
public class MailUtil {
	public static void sendMail(String recipient, String subject, String body) throws AddressException, MessagingException{
		// 네이버일 경우 smtp.naver.com 을 입력합니다.
				...
				//메일 관련 정보
				final String username = "rkfwltn12"; //네이버 아이디 @naver.com은 입력생략
				final String password = "jg5878"; //네이버 이메일 비밀번호 입력
				int port = 465; // 포트번호
				
				// 메일 내용
//				String recipient = "rkfwltn12@naver.com"; // 받는 사람의 메일주소
//				String subject = "메일 테스트"; // 메일 제목!
//				String body  = "http://naver.com"; // 메일 내용
				...
				mimeMessage.setFrom(new InternetAddress("rkfwltn12@naver.com"));
